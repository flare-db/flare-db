...
pub struct FnApiTransforms {}
/// Nested message and enum types in `FnApiTransforms`.
pub mod fn_api_transforms {
    #[derive(
        Clone,
        Copy,
        Debug,
...
pub struct InstructionRequest {
    ...
    #[prost(
        ...
        tags = "1001, 1002, 1003, 1004, 1005, 1006, 1007, 1000"
    )]
...
pub mod instruction_request {
    ...
    pub enum Request {
        ...
        SampleData(super::SampleDataRequest),
        /// DEPRECATED
...
pub mod instruction_response {
    ...
    pub enum Response {
        ...
        #[prost(message, tag = "1007")]
        SampleData(super::SampleDataResponse),
        /// DEPRECATED
        #[prost(message, tag = "1000")]
...
pub struct SampleDataRequest {
    ...
    pub pcollection_ids: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
}
...
pub struct SampledElement {
    ...
    pub sample_timestamp: ::core::option::Option<::prost_types::Timestamp>,
    /// (Optional) This will be set if this element was sampled because of a user
    /// exception.
    #[prost(message, optional, tag = "3")]
    pub exception: ::core::option::Option<sampled_element::Exception>,
}
/// Nested message and enum types in `SampledElement`.
pub mod sampled_element {
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct SampleDataResponse {
    ...
    pub element_samples: ::std::collections::HashMap<
        ::prost::alloc::string::String,
        sample_data_response::ElementList,
    >,
}
/// Nested message and enum types in `SampleDataResponse`.
pub mod sample_data_response {
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct ElementList {
        /// Required. The individual elements sampled from a PCollection.
        #[prost(message, repeated, tag = "1")]
        pub elements: ::prost::alloc::vec::Vec<super::SampledElement>,
    }
}
...
pub struct ProcessBundleProgressResponse {
    ...
    pub consuming_received_data: ::core::option::Option<bool>,
}
...
pub mod elements {
    ...
    /// Nested message and enum types in `DrainMode`.
    pub mod drain_mode {
        #[derive(
            Clone,
            Copy,
        ...
        impl Enum {
            ...
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
                match value {
                    ...
                    "NOT_DRAINING" => Some(Self::NotDraining),
    ...
    pub struct ElementMetadata {
        #[prost(enumeration = "drain_mode::Enum", optional, tag = "1")]
        pub drain: ::core::option::Option<i32>,
...
pub struct StateKey {
    ...
    #[prost(oneof = "state_key::Type", tags = "1, 2, 3, 4, 5, 8, 6, 10, 7, 9")]
...
pub mod state_key {
    ...
    /// details.
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
    pub struct MultimapKeysValuesSideInput {
        /// (Required) The id of the PTransform containing a side input.
        #[prost(string, tag = "1")]
        pub transform_id: ::prost::alloc::string::String,
        /// (Required) The id of the side input.
    ...
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
    pub struct MultimapEntriesUserState {
        /// (Required) The id of the PTransform containing user state.
        #[prost(string, tag = "1")]
        pub transform_id: ::prost::alloc::string::String,
        /// (Required) The id of the user state.
    ...
    /// details.
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
    pub struct OrderedListUserState {
        /// (Required) The id of the PTransform containing user state.
        #[prost(string, tag = "1")]
        pub transform_id: ::prost::alloc::string::String,
        /// (Required) The id of the user state.
        ...
        pub range: ::core::option::Option<super::OrderedListRange>,
    }
    /// (Required) One of the following state keys must be set.
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Oneof)]
    pub enum Type {
        ...
        #[prost(message, tag = "8")]
        MultimapKeysValuesSideInput(MultimapKeysValuesSideInput),
        #[prost(message, tag = "6")]
        MultimapKeysUserState(MultimapKeysUserState),
        #[prost(message, tag = "10")]
        MultimapEntriesUserState(MultimapEntriesUserState),
        #[prost(message, tag = "7")]
        MultimapUserState(MultimapUserState),
        #[prost(message, tag = "9")]
        OrderedListUserState(OrderedListUserState),
    }
}
/// A request to get state.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct LogEntry {
    ...
    /// Keys are limited to these characters: \[a-zA-Z\_-\]
...
pub mod beam_fn_control_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_process_bundle_descriptor(
            ...
            tonic::Response<super::ProcessBundleDescriptor>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod beam_fn_control_server {
    ...
    #[async_trait]
    pub trait BeamFnControl: std::marker::Send + std::marker::Sync + 'static {
        /// Server streaming response type for the Control method.
        type ControlStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::InstructionRequest, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        /// Instructions sent by the runner to the SDK requesting different types
    ...
    /// Stable
    #[derive(Debug)]
    pub struct BeamFnControlServer<T> {
        inner: Arc<T>,
                ...
                "/org.apache.beam.model.fn_execution.v1.BeamFnControl/Control" => {
                    ...
                    for ControlSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as BeamFnControl>::control(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/org.apache.beam.model.fn_execution.v1.BeamFnControl/GetProcessBundleDescriptor" => {
                    ...
                    > for GetProcessBundleDescriptorSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BeamFnControl>::get_process_bundle_descriptor(
                                        &inner,
                                        request,
                                    )
                                    .await
    ...
    impl<T> Clone for BeamFnControlServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "org.apache.beam.model.fn_execution.v1.BeamFnControl";
    impl<T> tonic::server::NamedService for BeamFnControlServer<T> {
...
pub mod beam_fn_data_server {
    ...
    #[async_trait]
    pub trait BeamFnData: std::marker::Send + std::marker::Sync + 'static {
        /// Server streaming response type for the Data method.
        type DataStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::Elements, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        /// Used to send data between harnesses.
                ...
                "/org.apache.beam.model.fn_execution.v1.BeamFnData/Data" => {
                    ...
                    for DataSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BeamFnData>::data(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for BeamFnDataServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "org.apache.beam.model.fn_execution.v1.BeamFnData";
    impl<T> tonic::server::NamedService for BeamFnDataServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
...
pub mod beam_fn_state_server {
    ...
    #[async_trait]
    pub trait BeamFnState: std::marker::Send + std::marker::Sync + 'static {
        /// Server streaming response type for the State method.
        type StateStream: tonic::codegen::tokio_stream::Stream<
        ...
        ) -> std::result::Result<tonic::Response<Self::StateStream>, tonic::Status>;
    }
    #[derive(Debug)]
    pub struct BeamFnStateServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
                ...
                "/org.apache.beam.model.fn_execution.v1.BeamFnState/State" => {
                    ...
                    for StateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BeamFnState>::state(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for BeamFnStateServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "org.apache.beam.model.fn_execution.v1.BeamFnState";
    impl<T> tonic::server::NamedService for BeamFnStateServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
...
pub mod beam_fn_logging_server {
    ...
    #[async_trait]
    pub trait BeamFnLogging: std::marker::Send + std::marker::Sync + 'static {
        /// Server streaming response type for the Logging method.
        type LoggingStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::LogControl, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        /// Allows for the SDK to emit log entries which the runner can
        ...
        ) -> std::result::Result<tonic::Response<Self::LoggingStream>, tonic::Status>;
    }
    /// Stable
    #[derive(Debug)]
    pub struct BeamFnLoggingServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
                ...
                "/org.apache.beam.model.fn_execution.v1.BeamFnLogging/Logging" => {
                    ...
                    for LoggingSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BeamFnLogging>::logging(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for BeamFnLoggingServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "org.apache.beam.model.fn_execution.v1.BeamFnLogging";
    impl<T> tonic::server::NamedService for BeamFnLoggingServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
pub mod beam_fn_external_worker_pool_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn start_worker(
            ...
            tonic::Response<super::StartWorkerResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn stop_worker(
            ...
            tonic::Response<super::StopWorkerResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod beam_fn_external_worker_pool_server {
    ...
    #[async_trait]
    pub trait BeamFnExternalWorkerPool: std::marker::Send + std::marker::Sync + 'static {
        /// Start the SDK worker with the given ID.
    ...
    #[derive(Debug)]
    pub struct BeamFnExternalWorkerPoolServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> BeamFnExternalWorkerPoolServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
                ...
                "/org.apache.beam.model.fn_execution.v1.BeamFnExternalWorkerPool/StartWorker" => {
                    ...
                    for StartWorkerSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BeamFnExternalWorkerPool>::start_worker(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/org.apache.beam.model.fn_execution.v1.BeamFnExternalWorkerPool/StopWorker" => {
                    ...
                    for StopWorkerSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BeamFnExternalWorkerPool>::stop_worker(
                                        &inner,
                                        request,
                                    )
                                    .await
    ...
    impl<T> Clone for BeamFnExternalWorkerPoolServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "org.apache.beam.model.fn_execution.v1.BeamFnExternalWorkerPool";
    impl<T> tonic::server::NamedService for BeamFnExternalWorkerPoolServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
...
pub mod beam_fn_worker_status_server {
    ...
    #[async_trait]
    pub trait BeamFnWorkerStatus: std::marker::Send + std::marker::Sync + 'static {
        /// Server streaming response type for the WorkerStatus method.
        type WorkerStatusStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::WorkerStatusRequest, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        async fn worker_status(
            ...
            tonic::Response<Self::WorkerStatusStream>,
            tonic::Status,
        >;
    }
    /// API for SDKs to report debug-related statuses to runner during pipeline execution.
    #[derive(Debug)]
    pub struct BeamFnWorkerStatusServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> BeamFnWorkerStatusServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
                ...
                "/org.apache.beam.model.fn_execution.v1.BeamFnWorkerStatus/WorkerStatus" => {
                    ...
                    for WorkerStatusSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BeamFnWorkerStatus>::worker_status(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T> Clone for BeamFnWorkerStatusServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "org.apache.beam.model.fn_execution.v1.BeamFnWorkerStatus";
    impl<T> tonic::server::NamedService for BeamFnWorkerStatusServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
pub mod provision_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_provision_info(
            ...
            tonic::Response<super::GetProvisionInfoResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod provision_service_server {
                ...
                "/org.apache.beam.model.fn_execution.v1.ProvisionService/GetProvisionInfo" => {
                    ...
                    for GetProvisionInfoSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ProvisionService>::get_provision_info(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "org.apache.beam.model.fn_execution.v1.ProvisionService";
