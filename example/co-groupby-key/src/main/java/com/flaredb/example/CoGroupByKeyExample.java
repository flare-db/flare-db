...
public class CoGroupByKeyExample {
  ...
  public static void main(String[] args) {
    ...
    PCollection<KV<String, Integer>> left =
        pipeline.apply("CreateLeft", Create.of(KV.of("a", 1), KV.of("a", 2), KV.of("b", 3)));

    PCollection<KV<String, String>> right =
        pipeline.apply("CreateRight", Create.of(KV.of("a", "x"), KV.of("a", "y"), KV.of("c", "z")));
    ...
    result.apply(
        "Print",
        ParDo.of(
            new DoFn<KV<String, CoGbkResult>, Void>() {
